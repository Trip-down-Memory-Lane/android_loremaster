...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.repository = (QuestionsRepository) intent.getSerializableExtra(HomeActivity.INTENT_KEY_REPOSITORY);
        int viewPagerStartIndex =
                intent.getIntExtra(
                        HomeActivity.INTENT_KEY_START_INDEX,
    ...
    public void viewScore(View v) {
        ...
        activityScore.putExtra(HomeActivity.INTENT_KEY_REPOSITORY, this.repository);
